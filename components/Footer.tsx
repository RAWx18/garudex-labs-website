      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-2xl font-bold mb-4 font-orbitron">Garudex Lab</h3>
            <p className="mb-4">Revolutionizing traffic management with AI precision.</p>
            <div className="flex space-x-4">
              <a href="#" className="text-saffron hover:text-gold transition-colors duration-200">
          ...
          <div className="w-full md:w-1/3">
            ...
            <p className="mb-2">IIITM, Gwalior</p>
            <p className="mb-2">admin@garudexlab.com</p>
            <p></p>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p>&copy; {new Date().getFullYear()} Garudex Lab. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
